...
sudo pacman -S --needed --noconfirm gtk4 gtk3 libadwaita python-gobject python-pillow python-cairo matugen swww cantarell-fonts
...
echo -e "${YLW}==> Done! Launch 'guhwall' via Rofi after the installation is complete.${NC}"
